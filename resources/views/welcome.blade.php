    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow-sm">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#home">
                <span class="text-primary">MAHBUBUR</span>
            </a>
                    ...
                    <div class="timeline">
                        <div class="timeline-item fade-in">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-primary mb-2">TechCorp Solutions • 2022 - Present</p>
                                <ul class="mb-0">
                                    <li>Led development of 5+ enterprise web applications serving 10,000+ users</li>
                                    <li>Reduced page load times by 45% through database optimization and caching strategies</li>
                        ...
                        <div class="timeline-item fade-in">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-primary mb-2">Digital Innovations Ltd • 2020 - 2022</p>
                                <ul class="mb-0">
                                    <li>Developed and maintained 15+ Laravel applications with Vue.js frontends</li>
                                    <li>Integrated payment gateways (bKash, Nagad, Stripe) increasing conversion by 30%</li>
                                    <li>Built RESTful APIs serving mobile applications with 99.9% uptime</li>
                        ...
                        <div class="timeline-item fade-in">
                            ...
                            <div class="timeline-content">
                                ...
                                <ul class="mb-0">
                                    <li>Developed custom WordPress themes and plugins for 20+ clients</li>
                                    <li>Migrated legacy PHP applications to Laravel framework</li>
                                    <li>Optimized MySQL queries improving application performance by 40%</li>
                        ...
                        <div class="timeline-item fade-in">
                            ...
                            <div class="timeline-content">
                                ...
                                <ul class="mb-0">
                                    <li>Built responsive websites using HTML, CSS, JavaScript, and Bootstrap</li>
                                    <li>Learned Laravel framework and contributed to team projects</li>
                                    <li>Participated in code reviews and agile development processes</li>
                                    <li>Gained experience with version control systems and deployment workflows</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section id="services" class="py-5 bg-light">
        <div class="container">
            <div class="text-center mb-5 fade-in">
                ...
                <p class="lead">Comprehensive web development solutions for your business</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Build robust, scalable REST APIs with Laravel following best practices and security standards.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Complete e-commerce solutions with inventory management, payment processing, and admin dashboards.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Interactive dashboards with real-time data visualization and comprehensive analytics reporting.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            <div class="service-icon bg-warning text-white rounded-circle mx-auto mb-3">
                                <i class="bi bi-speedometer2"></i>
                            </div>
                            <h5 class="card-title">Performance Optimization</h5>
                            <p class="card-text">Optimize existing applications for better performance, faster load times, and improved user experience.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="card-text">Integrate local and international payment gateways including bKash, Nagad, Stripe, and PayPal.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 fade-in">
                    <div class="card h-100 border-0 shadow-sm service-card">
                        <div class="card-body text-center p-4">
                            <div class="service-icon bg-secondary text-white rounded-circle mx-auto mb-3">
                                <i class="bi bi-puzzle"></i>
                            </div>
                            <h5 class="card-title">Third-party Integrations</h5>
                            <p class="card-text">Seamlessly integrate your applications with external APIs, services, and business tools.</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <img src="https://images.unsplash.com/photo-1494790108755-2616b612b786?w=80&h=80&fit=crop&crop=face&auto=format&q=80" 
                                             class="rounded-circle mb-3" alt="Sarah Johnson" loading="lazy">
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"Mahbub delivered an exceptional e-commerce platform that exceeded our expectations. His attention to detail and technical expertise helped us increase our online sales by 150%."</p>
                                        </blockquote>
                                        <footer class="blockquote-footer">
                                            <strong>Sarah Johnson</strong>
                                            <cite title="Source Title">CEO, Fashion Forward Ltd</cite>
                                        </footer>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8">
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=face&auto=format&q=80" 
                                             class="rounded-circle mb-3" alt="Michael Chen" loading="lazy">
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"Working with Mahbub was a game-changer for our startup. He built a scalable Laravel API that handles thousands of requests daily without any issues. Highly recommended!"</p>
                                        </blockquote>
                                        <footer class="blockquote-footer">
                                            <strong>Michael Chen</strong>
                                            <cite title="Source Title">CTO, TechStart Solutions</cite>
                                        </footer>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 shadow-sm glass-card">
                                    <div class="card-body text-center p-5">
                                        ...
                                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face&auto=format&q=80" 
                                             class="rounded-circle mb-3" alt="Ahmed Rahman" loading="lazy">
                                        <blockquote class="blockquote mb-3">
                                            <p class="lead">"The restaurant management system Mahbub developed has streamlined our operations completely. Order processing time reduced by 40% and customer satisfaction improved significantly."</p>
                                        </blockquote>
                                        <footer class="blockquote-footer">
                                            <strong>Ahmed Rahman</strong>
                                            <cite title="Source Title">Owner, Spice Garden Restaurant</cite>
                                        </footer>
                                    </div>
                                </div>
                            </div>
    ...
    <footer class="bg-dark text-light py-5">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted">&copy; 2025Md. Mahbubur Rahman. All rights reserved.</p>
                </div>
